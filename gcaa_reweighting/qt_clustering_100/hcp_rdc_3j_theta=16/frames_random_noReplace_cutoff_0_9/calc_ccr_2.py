...
#t = md.load("qt_clustering_100/hcp_rdc_3j_theta=16/frames_random_noReplace_cutoff_0_9/unlcustered_gcaa_frame72_ccr.pdb")
#t = md.load("nmrbundle_data/Bundle_Farfar2_ccr.pdb")
...
df.to_csv(sys.argv[1].split(".")[0] + "_calc.dat",sep=" ",index_label="frame",float_format='%8.4e')    #    md.load("1zih.pdb")     sys.argv[1]
#df.to_csv("qt_clustering_100/hcp_rdc_3j_theta=16/frames_random_noReplace_cutoff_0_9/test" + "_calc.dat",sep=" ",index_label="frame",float_format='%8.4e')
