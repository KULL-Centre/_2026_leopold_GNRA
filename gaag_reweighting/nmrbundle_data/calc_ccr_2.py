...
#t = md.load("qt_clustering_100/hcp_rdc_3j_theta=16/frames_random_cutoff_0_9/cluster_0_ccr.pdb")
#ff = "nmrbundle_data/Bundle_A_ccr.pdb"
#t = md.load(ff)
#B0 = 14.09
#ccr = "hcch"
...
req_atoms = ["C1\'","C2\'","C3\'","C4\'","C5\'","P","OP1","OP2","C8","H8","C6","H6",\
                "H1\'","H2\'","H3\'","H4\'","H5\'1","H5\'2","H2\'","H5\'","H5\'\'"]
...
df.to_csv(sys.argv[1].split(".")[0] + f"_{B0}" + "_calc.dat",sep=" ",index_label="frame",float_format='%8.4e')    #    md.load("1zih.pdb")     sys.argv[1]
#df.to_csv(ff.split("ccr")[0] + f"{ccr}" + "_calc.dat",sep=" ",index_label="frame",float_format='%8.4e')    #    md.load("1zih.pdb")     sys.argv[1]
#df.to_csv("nmrbundle_data/test" + "_calc.dat",sep=" ",index_label="frame",float_format='%8.4e')
